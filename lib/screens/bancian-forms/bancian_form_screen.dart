...
class BancianFormScreen extends StatefulWidget {
  const BancianFormScreen({super.key});

  @override
  State<BancianFormScreen> createState() => _BancianFormScreenState();
}

class _BancianFormScreenState extends State<BancianFormScreen> {
  int selectedIndex = 0;
