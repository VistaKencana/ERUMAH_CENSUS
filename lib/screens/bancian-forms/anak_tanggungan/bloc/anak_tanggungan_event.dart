...
class AddChildData extends AnakTanggunganEvent {
  final DependantInputModel data;

  const AddChildData({required this.data});
}
...
class AddOtherData extends AnakTanggunganEvent {
  final DependantInputModel data;

  const AddOtherData({required this.data});
}
