                  ...
                  children: [
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Image.asset(AppImages.activityBg.path),
                      ),
                    ),
                    Positioned(
                          ...
                          children: [
                            ...
                            Container(
                              margin: EdgeInsets.only(
                                  left: constraint.maxWidth * .08,
                                  right: constraint.maxWidth * .08),
                                        ...
                                        onTap: () {
                                          CustomDropdownSheet(
                                            ...
                                            onChange: (val) {
                                              ...
                                              _propertyBloc.add(
                                                  FetchBlock(areaData: val));
                                            },
                                            onQuery: (data, query) {
                                              final result = data.where((area) {
                                                String value = (area.desc ?? "")
                                                    .toLowerCase();
                                                return value.contains(
                                                    query?.toLowerCase() ?? "");
                                              }).toList();
                                        ...
                                        onTap: () {
                                          CustomDropdownSheet(
                                            ...
                                            getTitle: (data) =>
                                                data.blockNo ?? "-",
                                            groupValue:
                                                propertyWatch.selectedBlock,
                                            onChange: (val) {
                                              if (val == null) return;
                                              _propertyBloc.add(FetchUnitFloor(
                                                  blockData: val));
                                              setState(() => blockCtrl.text =
                                                  val.blockNo!);
                                            },
                                            onQuery: (data, query) {
                                        ...
                                        child: ElevatedButton(
                                            onPressed: () {
                                              ...
                                              _qrBloc.setPropertyData(
                                                  selectedZone: _propertyBloc
                                                      .selectedZone,
                                                  selectedArea: _propertyBloc
                                                      .selectedArea,
                                                  selectedBlock: _propertyBloc
                                                      .selectedBlock);
                                            },
