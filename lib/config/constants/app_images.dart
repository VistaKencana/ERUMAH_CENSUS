enum AppImages {
  ...
  successGreen(path: "assets/images/success_green.png"),
  //
  splash(path: "assets/images/splash_screen.png"),
  qrIcons(path: "assets/images/qr_icon.png"),
  greenBg(path: "assets/images/green_bg.png"),
  ;
