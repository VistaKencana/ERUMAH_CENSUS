...
class CustomFlushbar {
  ...
  Future<dynamic> showSuccess({required String msg, Duration? duration}) async {
    return Flushbar(
      message: msg,
  ...
  Future<dynamic> showFailed({required String msg, Duration? duration}) async {
    return Flushbar(
      message: msg,
      flushbarStyle: FlushbarStyle.FLOATING,
      flushbarPosition: FlushbarPosition.TOP,
  ...
  Future<dynamic> showWarning({required String msg, Duration? duration}) async {
    return Flushbar(
      isDismissible: false,
      flushbarPosition: FlushbarPosition.TOP,
      flushbarStyle: FlushbarStyle.FLOATING,
